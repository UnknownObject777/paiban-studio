...
} from "../internal/editor/runtime-bridge.js";
import {
...
import { EditorServer } from "../internal/editor/server.js";
import io, { type MockSocketOptions } from "../internal/editor/runtime-bridge.js";
import { EditorLogger } from "../internal/editor/logger.js";
import {
  type DocEditor,
  DocumentType,
...
import { getDocumentType, isOnlyOfficeCdnMode } from "../const/index.js";
import type { AscWordApiCallback, AscWordApiMethod } from "../type/word-api.js";
import { type OnlyOfficeIframeWindow } from "../type/sdk-internal.js";
import {
...
} from "../feature/comments.js";
import { onlyofficeEventbus } from "./eventbus.js";
import {
...
} from "../feature/revisions.js";
import { getOnlyOfficeLang, type OnlyOfficeLang } from "../store/lang.js";
import { getDocumentObj, setDocumentObj } from "../store/document.js";
import { initializeOnlyOffice } from "../util/initialize.js";
import {
  removeOfficeXmlSizeLimitOverlay,
  showOfficeXmlSizeLimitOverlay,
} from "../internal/ui/office-xml-size-limit-overlay.js";
