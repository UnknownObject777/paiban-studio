...
import { convertBinToDocument } from "../util/x2t.js";
import type { User } from "../internal/editor/types.js";
import { EditorManager, editorManagerFactory } from "./editor-manager.js";
import {
  onlyofficeEventbus,
